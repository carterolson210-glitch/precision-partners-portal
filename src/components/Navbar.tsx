      ...
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2">
          <div className="w-8 h-8 bg-navy rounded flex items-center justify-center">
            <span className="text-primary-foreground font-display font-bold text-sm">PE</span>
          </div>
          <span className="font-display font-bold text-lg text-body-text">Precision<span className="text-gold">Eng</span></span>
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-3">
          <Button variant="outline" size="default">Request a Quote</Button>
          <Button variant="gold" size="default">Client Portal</Button>
        </div>
        ...
        <>
          ...
          <div className="fixed top-[var(--nav-height)] left-0 right-0 bg-background z-[1000] border-b border-card-border p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 pt-4 border-t border-card-border">
              ...
              <Button variant="gold" className="w-full">Client Portal</Button>
            </div>
          </div>
        </>
      )}
